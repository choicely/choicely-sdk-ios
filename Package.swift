...
let package = Package(
    ...
    dependencies: [
        ...
        .package(url: "git@github.com:firebase/FirebaseUI-iOS.git", .upToNextMajor(from: "15.0.0"))
    ],
    targets: [
        .target(
            name: "Choicely",
        ...
        .binaryTarget(
            name: "ChoicelyCore",
            url: "https://github.com/choicely/choicely-sdk-ios/releases/download/0.0.47/ChoicelyCore.xcframework.zip",
            checksum: "ad66f88ec22210b627d9dcb522c6d7c3c10dc921784b8bae1f3721bc52065d44"
        ),
        .binaryTarget(
            name: "ChoicelyMap",
            url: "https://github.com/choicely/choicely-sdk-ios/releases/download/0.0.47/ChoicelyMap.xcframework.zip",
            checksum: "c7498ddbc942a3e63a383e12d1c4cea444951999c77bc7462fbfd6996c2f2eb4"
        ),
        .binaryTarget(
            name: "ChoicelyFirebase",
            url: "https://github.com/choicely/choicely-sdk-ios/releases/download/0.0.47/ChoicelyFirebase.xcframework.zip",
            checksum: "4c45cfb07e6c8192f7d106a956f3611e3535a9132d55a72c001399c7ad38f252"
        ),
        .binaryTarget(
            name: "ChoicelyShop",
            url: "https://github.com/choicely/choicely-sdk-ios/releases/download/0.0.47/ChoicelyShop.xcframework.zip",
            checksum: "a5e66f192c72088294188b63caec0c8e50acf33af023e36707f4d92bc0797918"
        ),
        .binaryTarget(
            name: "ChoicelyAd",
            url: "https://github.com/choicely/choicely-sdk-ios/releases/download/0.0.47/ChoicelyAd.xcframework.zip",
