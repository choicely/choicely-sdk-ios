...
let package = Package(
    ...
    targets: [
        ...
        .binaryTarget(
            name: "ChoicelyCore",
            url: "https://github.com/choicely/choicely-sdk-ios/releases/download/0.9.18/ChoicelyCore.xcframework.zip",
            checksum: "8bec34b6df5e48993422a4485bdc71b30a8076eddcb99564dff082dc978bedaf"
        ),
        .binaryTarget(
            name: "ChoicelyMap",
            url: "https://github.com/choicely/choicely-sdk-ios/releases/download/0.9.18/ChoicelyMap.xcframework.zip",
            checksum: "be9e86f985ebabc5d7f5c9b6b68ff0867fd7d23429d0922865e4678e16e9274e"
        ),
        .binaryTarget(
            name: "ChoicelyFirebase",
            url: "https://github.com/choicely/choicely-sdk-ios/releases/download/0.9.18/ChoicelyFirebase.xcframework.zip",
            checksum: "1b1e18c3057c6e1b73fe236788ecc6c3abdf94db1df5fee94b289286d54b85b8"
        ),
        .binaryTarget(
            name: "ChoicelyShop",
            url: "https://github.com/choicely/choicely-sdk-ios/releases/download/0.9.18/ChoicelyShop.xcframework.zip",
