...
let package = Package(
    ...
    targets: [
        ...
        .binaryTarget(
            name: "ChoicelyCore",
            url: "https://github.com/choicely/choicely-sdk-ios/releases/download/1.0.2/ChoicelyCore.xcframework.zip",
            checksum: "20321dbe23f19a57c77fc19df96e21a6f38f34d0145de1a63ae592130291a954"
        ),
        .binaryTarget(
            name: "ChoicelyMap",
            url: "https://github.com/choicely/choicely-sdk-ios/releases/download/1.0.2/ChoicelyMap.xcframework.zip",
            checksum: "c02ef3a5d0a0158fab529f0d6b39214de7e7a9b2be39014e2435a7a8aa1a8bc0"
        ),
        .binaryTarget(
            name: "ChoicelyFirebase",
            url: "https://github.com/choicely/choicely-sdk-ios/releases/download/1.0.2/ChoicelyFirebase.xcframework.zip",
            checksum: "58555bb16cc59fb6857c1183c8d9755e5c6e4ed8fb1127ef9afb1614c6bfc7fc"
        ),
        .binaryTarget(
            name: "ChoicelyShop",
            url: "https://github.com/choicely/choicely-sdk-ios/releases/download/1.0.2/ChoicelyShop.xcframework.zip",
