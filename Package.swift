...
let package = Package(
    ...
    targets: [
        ...
        .binaryTarget(
            name: "ChoicelyCore",
            url: "https://github.com/choicely/choicely-sdk-ios/releases/download/0.0.39/ChoicelyCore.xcframework.zip",
            checksum: "ba903509ffe8bf5b592a1443e0845ed69c3334a7a5c2317f88e876a307a0ddb5"
        ),
        .binaryTarget(
            name: "ChoicelyMap",
            url: "https://github.com/choicely/choicely-sdk-ios/releases/download/0.0.39/ChoicelyMap.xcframework.zip",
            checksum: "679a54752a032207b558ffec4d658db6125ca85c6012a9c86fe43a8baf36e2e0"
        ),
        .binaryTarget(
            name: "ChoicelyFirebase",
            url: "https://github.com/choicely/choicely-sdk-ios/releases/download/0.0.39/ChoicelyFirebase.xcframework.zip",
            checksum: "78f59732d14114affa832bac4ff12462784c5f663df731d4de2d6245b8b73e84"
        ),
        .binaryTarget(
            name: "ChoicelyShop",
            url: "https://github.com/choicely/choicely-sdk-ios/releases/download/0.0.39/ChoicelyShop.xcframework.zip",
            checksum: "b685e163e3d57c28d22e87307779dc4acdb122166d4c74d460e24c90b1889dd0"
        ),
        .binaryTarget(
            name: "ChoicelyAd",
            url: "https://github.com/choicely/choicely-sdk-ios/releases/download/0.0.39/ChoicelyAd.xcframework.zip",
